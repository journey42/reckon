...
options: List[str] = ["Technical Problem", "Rhetorical Issue", "Other"]

class GeneralFeedbackModalState(AppState):
    """Feedback state."""
    show: bool = False
    content: str = ""
...
def general_feedback_modal():
    ...
    return rx.box(
        rx.modal(
            rx.modal_overlay(
                rx.modal_content(
                        ...
                        rx.form(
                            rx.vstack(
                                rx.select(
                                    ...
                                    on_change=GeneralFeedbackModalState.set_type,
                                ...
                                rx.text_area(
                                    ...
                                    width="100%",
                                    **input_style,
                                    on_blur=GeneralFeedbackModalState.set_content,
                                ),
                            )
                        )
                    ),
                    rx.modal_footer(
                        rx.button(
                            "Submit",
                            on_click=GeneralFeedbackModalState.submit,
                            **button_style,
                            m=2
                        ),
                        rx.button(
                            "Cancel",
                            on_click=GeneralFeedbackModalState.visible,
                            **button_style,
                            m=2
                        )
                    ),
            ...
            is_open=GeneralFeedbackModalState.show,
        ),
    )